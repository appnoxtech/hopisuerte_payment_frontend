        ...
        return (
            <div style={mainStyle}>
                ...
                <div className="login-container">
                    ...
                    {/* Card */}
                    <div className="login-card" style={{ animation: 'fadeInUp 0.5s ease-out' }}>
                        {/* Success Icon */}
                        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                            <div style={{
                                ...
                                <svg width="28" height="28" fill="none" stroke="#0070E0" viewBox="0 0 24 24">
                        ...
                        <div style={{
                            height: '1px',
                            background: 'linear-gradient(to right, transparent, #E3E8EF 30%, #E3E8EF 70%, transparent)',
                            margin: '24px 0'
                        }} />
            ...
            <div style={containerStyle}>
                <div style={cardStyle} className="transition-all duration-300 hover:scale-[1.01] hover:-translate-y-1 hover:shadow-2xl hover:border-blue-500/10">
                    <div style={headerScope}>
                        ...
                        <p style={subtitleStyle}>Initialize new secure password for your super admin account</p>
                    </div>
